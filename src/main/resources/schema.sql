...
CREATE TABLE IF NOT EXISTS FEED (
    ...
    CONSTRAINT operation_values CHECK(operation IN ('ADD', 'UPDATE', 'REMOVE'))
);
...
ALTER TABLE review ADD FOREIGN KEY (film_id) REFERENCES FILM (film_id) ON DELETE CASCADE;

ALTER TABLE review ADD FOREIGN KEY (user_id) REFERENCES USERS (user_id) ON DELETE CASCADE;

ALTER TABLE review_like ADD FOREIGN KEY (review_id) REFERENCES REVIEW (review_id) ON DELETE CASCADE;

ALTER TABLE review_like ADD FOREIGN KEY (user_id) REFERENCES USERS (user_id) ON DELETE CASCADE;
...
CREATE INDEX IF NOT EXISTS IDX_REVIEW_LIKE ON REVIEW_LIKE(review_id, user_id);

CREATE INDEX IF NOT EXISTS IDX_REVIEW ON REVIEW(film_id, user_id);

CREATE INDEX IF NOT EXISTS IDX_FILM_DIRECTOR ON FILM_DIRECTOR(film_id, director_id);

CREATE INDEX IF NOT EXISTS IDX_FILM_GENRE ON FILM_GENRE(film_id, genre_id);

CREATE INDEX IF NOT EXISTS IDX_FILM_LIKE ON FILM_LIKE(film_id, user_id);